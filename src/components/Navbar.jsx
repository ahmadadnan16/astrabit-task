...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between mx-[60px] py-5">
      <div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={50}
          height="48.121"
          viewBox="0 0 50 48.121"
        >
          <g
            id="logo-rackext-svgrepo-com"
            transform="translate(-30.462 -33.896)"
          >
            <path
              id="Path_3844"
              data-name="Path 3844"
              d="M31.282,81.106l-.343-.684-.462-.885-.015-42.41.287-1.236.845-1.3,1.234-.7,44.666.029,1.311.629,1.253,1.058.4,1.014L80.415,79.4l-.579,1.286L79,81.639l-1.365.377L33.678,81.98l-1.429-.3-.966-.579Zm1.275-1.9.322.56.476.373,44.3-.1.374-.351.386-.637-.041-42.211-.4-.559-.4-.312-44.325.04-.52.309-.313.579Z"
              fill="#4a4ed4"
              fillRule="evenodd"
            />
            <path
      ...
      <div className="flex gap-16">
        <ul className="flex gap-[45px] items-center text-[#1A1B1E] font-apercupro font-medium nav-text ">
          <li className="cursor-pointer">Dashboard</li>
          <li className="cursor-pointer">FAQs</li>
          <li  className="cursor-pointer">Support</li>
        </ul>
        <div className="flex items-center gap-3 border border-[#4A4ED4] rounded-3xl px-6 py-3" onMouseEnter={()=>setIsOpen(true)} onMouseLeave={()=>setIsOpen(false)}>
          <div >
            <svg
              className="w-4"
...
s7.794-1.581,10.606-4.394l149.996-150C331.465,94.749,331.465,85.251,325.607,79.393z"
          ...
          {
            isOpen && <div className="absolute  top-[80px] right-[60px] w-[238px] bg-white drop-shadow-md text-black/70 font-apercupro font-medium">
            <ul className="mx-5 my-6 cursor-pointer">
            <li className="flex gap-3 items-center pb-6"><svg xmlns="http://www.w3.org/2000/svg" width="19.968" height="20" viewBox="0 0 19.968 20">
           ...
           My Profile</li>
            <li className="flex gap-3 items-center pb-6"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="18.762" viewBox="0 0 20 18.762">
          ...
          My Transactions</li>
            <li className="flex gap-3 items-center"><svg xmlns="http://www.w3.org/2000/svg" width="18.904" height="20" viewBox="0 0 18.904 20">
